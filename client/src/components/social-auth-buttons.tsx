...
export default function SocialAuthButtons({ onSuccess, mode }: SocialAuthButtonsProps) {
  ...
  function handleGoogleClick() {
    if (!config?.googleClientId) {
      toast({ title: "Google Sign-In is not yet configured", description: "Please contact the church admin to enable this feature.", variant: "destructive" });
      return;
    }
  ...
  async function handleAppleClick() {
    if (!config?.appleClientId) {
      toast({ title: "Apple Sign-In is not yet configured", description: "Please contact the church admin to enable this feature.", variant: "destructive" });
      return;
    }
    ...
    <div className="space-y-3">
      ...
      <div className="flex flex-col gap-2">
        ...
        <Button
          ...
          className="w-full bg-black text-white border-white/20"
